import { useFormSelector, useFormDispatch } from "@/app/page";
import styles from "./Switch.module.css";
import { DonateType } from "@/state/formtypes";
import { setOption } from "@/state/reducers";
...
export const Option = () => {
  ...
  return (
    <div className="flex flex-row w-full">
      ...
      >
        <div className="flex content-center items-center w-[80px] h-[80px] rounded-full bg-[rgba(47,47,47,0.16)] mb-2">
          <svg
            className="m-auto"
            width="29"
            height="29"
          ...
          >
            <g clipPath="url(#clip0_6705_46)">
              <path
                ...
                stroke={option === DonateType.whole ? "#9F9F9F" : "white"}
                strokeWidth="2"
                strokeMiterlimit="10"
                strokeLinecap="round"
      ...
      >
        <div className="w-[80px] h-[80px] rounded-full bg-[rgba(47,47,47,0.16)] mb-2 flex content-center items-center">
          <svg
            className="m-auto"
            width="34"
            height="34"
          ...
          >
            <path
              ...
              fill={option === DonateType.whole ? "white" : "#9F9F9F"}
            />
            <path
