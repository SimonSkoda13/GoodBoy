...
export const AmountSelector = (props: AmountSelectorProps) => {
  ...
  if (props.type === AmountType.basic && amount !== undefined) {
    return (
      <div
        className={
          "flex flex-row content-center items-center mx-2 p-4 bg-white text-black border border-black hover:bg-primary-900 transition ease-in-out cursor-pointer rounded-md" +
          (amount === formAmount
  ...
  return (
    <div className="flex flex-row content-center items-center mx-2 p-4 bg-white text-black border-black transition ease-in-out cursor-pointer border rounded-md">
      <input
        className={
